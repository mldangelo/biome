...
// Valid: utility function calls with duplicates but no `functions` option configured
cn("flex flex");
clsx("p-4 m-2 p-4");

// Valid: object member names with duplicates but no `functions` option configured
